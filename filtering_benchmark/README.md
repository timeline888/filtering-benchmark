...
**滤波基石系统** 是一个面向旋转机械故障诊断领域的信号滤波降噪算法评估与对比系统。系统参考多本滤波算法专著，集成了 **91 种** 主流滤波降噪算法，覆盖从经典滤波到深度学习、从时频分析到稀疏表示的完整算法谱系。
...
- 大信号安全上限检查
- **性能优化**：详见 [性能优化分析报告](./docs/performance_optimization_report.md)
